...
def create_vtk(x,y,z):
	...
	# 	plt.scatter(x.detach().numpy(), y.detach().numpy(),z.detach().numpy(), c = output_u ,vmin=0, vmax=0.58, cmap = 'rainbow')
...
if (Flag_physical):
    ...
    mesh_file = "Data/3D-aneurysm/IA_mesh3D_nearwall_small_physical.vtu"
else:
...
output_filename = "Results/IA_PINN_3Ddata.vtk"
